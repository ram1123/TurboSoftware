...
awk -v OFS="\t" 'NR==FNR && NR==7 {a=$3} NR==FNR {next} FNR==11 {$3=$3-a} {print}' fit_detail_$1.txt OffsetFlip_EventBuilderVFAT_Oct2014_H2_Run1118AndUp.conf.buffer1 > OffsetFlip_EventBuilderVFAT_Oct2014_H2_Run1118AndUp.conf.buffer2
awk -v OFS="\t" 'NR==FNR && NR==8 {a=$3} NR==FNR {next} FNR==14{$3=$3-a} {print}' fit_detail_$1.txt OffsetFlip_EventBuilderVFAT_Oct2014_H2_Run1118AndUp.conf.buffer2 > OffsetFlip_EventBuilderVFAT_Oct2014_H2_Run1118AndUp.conf_Run$1_Ite$2
