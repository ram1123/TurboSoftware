...
#  fi
  ...
  do
	...
	do
		cut2=$((cut + 5))
		awk 'NR==4{$(NF-9) = "'${cut}'"}1' OFS="\t" FS="\t" ConfigFiles/OffsetAndCoverage_Analyzer_N0V2014_H4_AboveRun1864.conf  > tmp1.conf
		...
		cp tmp2.conf ConfigFiles/OffsetAndCoverage_Analyzer_N0V2014_H4_AboveRun1864.conf
		#sleep 5
