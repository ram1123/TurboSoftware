...
#
#####################################################################################################
awk -v OFS="\t" 'NR==FNR && NR==8 {a=$4} NR==FNR {next} FNR==6	{$2=$2-a} {print}' OffsetFile.log  ConfigFiles/OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf > OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf.buffer1
...
awk -v OFS="\t" 'NR==FNR && NR==13 {a=$4} NR==FNR {next} FNR==13 {$2=$2-a} {print}' OffsetFile.log OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf.buffer1 > OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf.buffer2
...
cp OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf.buffer1 ConfigFiles/OffsetFlip_EventBuilderVFAT_NOV2014_H4.conf
