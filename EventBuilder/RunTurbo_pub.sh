...
#	-------------------------------------------------------------------
	...
	PathOfOutputData=/afs/cern.ch/user/r/rasharma/work/public/GEM_TBA
	CheckInteger='^[0-9]+$'
	PROGNAME=$(basename $0)
	VERSION="0.0.1"
...
#	------------------------------------------------------------------------
	cd $PathOfOutputData
	if [ -d "H2TB_Oct14_v_1_1_3_WithRot_StripWidth08" ]; then
		echo "Directory H2TB_Oct14_v_1_1_3_WithRot_StripWidth08 Exists......."
	else
		mkdir H2TB_Oct14_v_1_1_3_WithRot_StripWidth08
		echo "Directory H2TB_Oct14_v_1_1_3_WithRot_StripWidth08 Created................."
	fi
	PathOfOutPutData=$PathOfOutputData/H2TB_Oct14_v_1_1_3_WithRot_StripWidth08
	cd -
	return
