...
// Tue Oct 11 16:10:18 2011 by ROOT version 5.27/04
// from TTree recotree/RecoGeonstruction routine results
// found on file: ../RootData/RECO-CRC-Run156_Tr1720Tr24700_1T2_2T2offCTL740_l0_IComp60-111005_080343-0.root
//////////////////////////////////////////////////////////

#ifndef TrackerReco_h
#define TrackerReco_h
...
class TrackerReco : public TSelector {
public :
   ...
   ClassDef(TrackerReco,0);
};

#endif

#ifdef TrackerReco_cxx
void TrackerReco::Init(TTree *tree)
{
