...
// Thu Oct 13 20:26:20 2011 by ROOT version 5.27/04
// from TTree rd51tbgeo/RD51 test beam geometry
// found on file: ../RootData/CRC-Run156_Tr1720Tr24700_1T2_2T2offCTL740_l0_IComp60-111005_080343-0.root
//////////////////////////////////////////////////////////

#ifndef DataForTracking_h
#define DataForTracking_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
#include <TSelector.h>
   const Int_t kMaxg1xcl = 		100;//15;
   const Int_t kMaxg1ycl = 		100;// 9;
   const Int_t kMaxg2xcl = 		100;// 9;
   const Int_t kMaxg2ycl = 	 	100;//11;
   const Int_t kMaxg3xcl = 		100;// 1;
   const Int_t kMaxg3ycl = 		100;// 1;
   const Int_t kMaxg4xcl = 		100;//11;
   const Int_t kMaxg4ycl = 		100;//12;
   const Int_t kMaxgCMSTimingcl = 	100;// 1;
   const Int_t kMaxgCMSLGcl = 		100;// 2;
   const Int_t kMaxg1T2Padscl = 	100;// 1;
   const Int_t kMaxg2T2Padscl = 	100;// 1;
   const Int_t kMaxg1T2Stripscl = 	100;// 5;
   const Int_t kMaxg2T2Stripscl = 	100;// 1;
   const Int_t kMaxgCTLBottomLeftxcl = 	100;// 4;
   const Int_t kMaxgCTLBottomLeftycl = 	100;// 4;
   const Int_t kMaxgCTLMiddleLeftycl = 	100;//20;
   const Int_t kMaxgCTLTopLeftxcl = 	100;// 1;
   const Int_t kMaxgCTLTopLeftycl = 	100;// 1;
   const Int_t kMaxgCTLTopMiddlexcl = 	100;//23;
   const Int_t kMaxgCTLTopRightxcl = 	100;// 1;
   const Int_t kMaxgCTLTopRightycl = 	100;// 1;

   const Float_t kPitch =		0.4;
   const Int_t kNumberOfDetector = 	  6;
   const Int_t kMaxNumberOfClusters = 	 15;


class DataForTracking : public TSelector {
public :
   ...
   Float_t pos[kNumberOfDetector][kMaxNumberOfClusters], erPos[kNumberOfDetector][kMaxNumberOfClusters];
   Int_t ncl[kNumberOfDetector];
   ...
   Int_t           gCMSTimingcl_;
   Int_t           gCMSTimingcl_ngeoch[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Int_t          *gCMSTimingcl_geoch[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t        *gCMSTimingcl_geoX[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t        *gCMSTimingcl_geoY[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t        *gCMSTimingcl_geoZ[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t        *gCMSTimingcl_geoR[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t        *gCMSTimingcl_geoPhi[kMaxgCMSTimingcl];   //[gCMSTimingcl_ngeoch]
   Float_t         gCMSTimingcl_geoposch[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Float_t         gCMSTimingcl_geoposX[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Float_t         gCMSTimingcl_geoposY[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Float_t         gCMSTimingcl_geoposZ[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Float_t         gCMSTimingcl_geoposR[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Float_t         gCMSTimingcl_geoposPhi[kMaxgCMSTimingcl];   //[gCMSTimingcl_]
   Int_t           gCMSLGcl_;
   ...
   TBranch        *b_gCMSTimingcl_;   //!
   TBranch        *b_gCMSTimingcl_ngeoch;   //!
   TBranch        *b_gCMSTimingcl_geoch;   //!
   TBranch        *b_gCMSTimingcl_geoX;   //!
   TBranch        *b_gCMSTimingcl_geoY;   //!
   TBranch        *b_gCMSTimingcl_geoZ;   //!
   TBranch        *b_gCMSTimingcl_geoR;   //!
   TBranch        *b_gCMSTimingcl_geoPhi;   //!
   TBranch        *b_gCMSTimingcl_geoposch;   //!
   TBranch        *b_gCMSTimingcl_geoposX;   //!
   TBranch        *b_gCMSTimingcl_geoposY;   //!
   TBranch        *b_gCMSTimingcl_geoposZ;   //!
   TBranch        *b_gCMSTimingcl_geoposR;   //!
   TBranch        *b_gCMSTimingcl_geoposPhi;   //!
   TBranch        *b_gCMSLGcl_;   //!
   ...
   DataForTracking(TTree * /*tree*/ =0) { }
   virtual ~DataForTracking() { }
   ...
   ClassDef(DataForTracking,0);
};

#endif

#ifdef DataForTracking_cxx
void DataForTracking::Init(TTree *tree)
{
   ...
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoch[i] = 0;
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoX[i] = 0;
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoY[i] = 0;
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoZ[i] = 0;
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoR[i] = 0;
   for(int i=0; i<kMaxgCMSTimingcl; ++i) gCMSTimingcl_geoPhi[i] = 0;
   ...
   fChain->SetBranchAddress("gCMSTimingcl", &gCMSTimingcl_, &b_gCMSTimingcl_);
   fChain->SetBranchAddress("gCMSTimingcl.ngeoch", &gCMSTimingcl_ngeoch, &b_gCMSTimingcl_ngeoch);
   fChain->SetBranchAddress("gCMSTimingcl.geoch", &gCMSTimingcl_geoch, &b_gCMSTimingcl_geoch);
   fChain->SetBranchAddress("gCMSTimingcl.geoX", &gCMSTimingcl_geoX, &b_gCMSTimingcl_geoX);
   fChain->SetBranchAddress("gCMSTimingcl.geoY", &gCMSTimingcl_geoY, &b_gCMSTimingcl_geoY);
   fChain->SetBranchAddress("gCMSTimingcl.geoZ", &gCMSTimingcl_geoZ, &b_gCMSTimingcl_geoZ);
   fChain->SetBranchAddress("gCMSTimingcl.geoR", &gCMSTimingcl_geoR, &b_gCMSTimingcl_geoR);
   fChain->SetBranchAddress("gCMSTimingcl.geoPhi", &gCMSTimingcl_geoPhi, &b_gCMSTimingcl_geoPhi);
   fChain->SetBranchAddress("gCMSTimingcl.geoposch", &gCMSTimingcl_geoposch, &b_gCMSTimingcl_geoposch);
   fChain->SetBranchAddress("gCMSTimingcl.geoposX", &gCMSTimingcl_geoposX, &b_gCMSTimingcl_geoposX);
   fChain->SetBranchAddress("gCMSTimingcl.geoposY", &gCMSTimingcl_geoposY, &b_gCMSTimingcl_geoposY);
   fChain->SetBranchAddress("gCMSTimingcl.geoposZ", &gCMSTimingcl_geoposZ, &b_gCMSTimingcl_geoposZ);
   fChain->SetBranchAddress("gCMSTimingcl.geoposR", &gCMSTimingcl_geoposR, &b_gCMSTimingcl_geoposR);
   fChain->SetBranchAddress("gCMSTimingcl.geoposPhi", &gCMSTimingcl_geoposPhi, &b_gCMSTimingcl_geoposPhi);
...
#endif // #ifdef DataForTracking_cxx
